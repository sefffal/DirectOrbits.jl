...
# solar mass <-> Jupiter mass
const solar2jup = 1047.594211
const jup2solar = 0.0009545680851418908
...
semiamplitude(elem::KeplerianElements, M_planet) = M_planet/(elem.M + M_planet) * elem.K
